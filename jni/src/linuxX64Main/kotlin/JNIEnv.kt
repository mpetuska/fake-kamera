...
fun JNIEnvVar.GetStringUTFChars(string: jstring?, p3: CPointer<jbooleanVar>?) =
  pointed?.GetStringUTFChars?.invoke(ptr, string, p3)

fun JNIEnvVar.ReleaseStringUTFChars(string: jstring?, p3: CPointer<ByteVar>?) =
  pointed?.ReleaseStringUTFChars?.invoke(ptr, string, p3)
